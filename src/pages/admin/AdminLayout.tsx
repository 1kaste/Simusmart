...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-background-dark font-sans">
      {/* Mobile overlay */}
      {isSidebarOpen && (
        <div 
      ...
      {/* Sidebar */}
      <aside className={`fixed top-0 left-0 h-screen w-64 flex-shrink-0 bg-primary-dark text-white flex flex-col z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
      ...
      <div className="lg:pl-64">
         <header className="lg:hidden h-16 flex items-center justify-between px-4 sm:px-6 bg-white dark:bg-primary-dark border-b dark:border-gray-800 sticky top-0 z-20">
